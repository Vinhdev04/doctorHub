...
<body>
    ...
    <div class="container py-4 position-relative">
        ...
        <h1 class="h4 font-weight-bold mb-2">Châm Cứu</h1>
        <h2 class="h5 font-weight-semibold mb-2">Bác sĩ Y học Cổ truyền uy tín đầu ngành tại Việt Nam:</h2>
        ...
        <div class="bg-white shadow rounded-lg mt-4 p-4" data-doctor-id="35">
            <div class="d-flex flex-column flex-md-row">
                <div class="d-flex flex-1 align-items-start mb-4 mb-md-0">
                    ...
                    <div class="flex-1" style="margin-left: 10px;">
                        <div class="d-flex align-items-center mb-2">
                            <h3 class="h6 font-weight-bold">Phó Giáo sư, Tiến sĩ, Bác sĩ Dương Trọng Nghĩa</h3>
                        </div>
                        
                        <p class="text-muted mb-2" style="font-size: 15px;">Phó Giám đốc Bệnh viện Y học Cổ truyền Trung ương</p>
                ...
                <div class="flex-1 mt-4 mt-md-0 ml-md-4" style="margin-left: 10px;">
                    ...
                    <div class="d-flex flex-wrap mb-4">
                        <button class="btn btn-secondary mb-2 time-slot" data-time="07:30 - 08:00" data-doctor-id="35" style="height: 40px; width: 126.06px;">07:30 - 08:00</button>
                        <button class="btn btn-secondary mb-2 time-slot" data-time="08:30 - 09:00" data-doctor-id="35" style="height: 40px; width: 126.06px;">08:30 - 09:00</button>
                        <button class="btn btn-secondary mb-2 time-slot" data-time="09:30 - 10:00" data-doctor-id="35" style="height: 40px; width: 126.06px;">09:30 - 10:00</button>
                        <button class="btn btn-secondary mb-2 time-slot" data-time="10:30 - 11:00" data-doctor-id="35" style="height: 40px; width: 126.06px;">10:30 - 11:00</button>
                        <button class="btn btn-secondary mb-2 time-slot" data-time="13:30 - 14:00" data-doctor-id="35" style="height: 40px; width: 126.06px;">13:30 - 14:00</button>
                        <button class="btn btn-secondary mb-2 time-slot" data-time="14:30 - 15:00" data-doctor-id="35" style="height: 40px; width: 126.06px;">14:30 - 15:00</button>
                        <button class="btn btn-secondary mb-2 time-slot" data-time="15:00 - 15:30" data-doctor-id="35" style="height: 40px; width: 126.06px;">15:00 - 15:30</button>
                        <button class="btn btn-secondary mb-2 time-slot" data-time="15:30 - 16:00" data-doctor-id="35" style="height: 40px; width: 126.06px;">15:30 - 16:00</button>
                    </div>
                                ...
                                <table>
                                    <tr>
                                        <td class="service-name" colspan="2">
                                            ...
                                            <p class="note">Khám ngoại trú: Không được bảo hiểm y tế chi trả.</p>
                                            <p class="note">Điều trị nội trú (nằm viện): Được bảo hiểm y tế chi trả 40% chi phí.</p>
                                        </td>
                                    </tr>
                                </table>
                            </div>
