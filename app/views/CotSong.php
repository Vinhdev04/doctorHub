...
<body>
    ...
    <div class="container py-4 position-relative">
        <img alt="Background image" class="background-image" src="../../assets/images/Icon/cot-song.png"/>
        <div class="text-muted mb-2">
            <a class="text-primary" href="./chuyenkhoa.php">Khám chuyên khoa</a> /
            <span>Cột Sống</span>
        </div>
        <h1 class="h4 font-weight-bold mb-2">Cột Sống</h1>
        <h2 class="h5 font-weight-semibold mb-2">Bác sĩ Chuyên khoa Cột sống</h2>
        <p class="mb-4">Danh sách các bác sĩ Cột sống uy tín đầu ngành tại Việt Nam.</p>
        <ul class="list-unstyled mb-4">
        <li class="mb-2">Các chuyên gia có quá trình đào tạo bài bản, kinh nghiệm công tác tại các bệnh viện lớn về chuyên khoa Thần kinh - Cột sống - Xương khớp tại Hà Nội</li>
            <li class="mb-2">Các giáo sư, tiến sĩ, bác sĩ là giảng viên Đại học Y khoa Hà Nội, Học viện Quân Y.</li>
            <li class="mb-2">Các bác sĩ đã, đang công tác tại chuyên Khoa Thần Kinh, Cột sống, Xương Khớp - Bệnh viện Bạch Mai, Bệnh Viện Việt Đức, Bệnh Viện Trung ương Quân đội 108, Bệnh viện 103...</li>
        ...
        <div id="additionalContent" style="display: none;">
            <h3 class="h5 font-weight-semibold mt-3">Bệnh Thần kinh - Cột sống</h3>
            ...
            <div class="d-flex flex-column flex-md-row">
                <div class="d-flex flex-1 align-items-start mb-4 mb-md-0">
                    ...
                    <div class="flex-1" style="margin-left: 10px;">
                        ...
                        <p class="text-muted mb-2" style="font-size: 15px;">Bác sĩ có 35 năm kinh nghiệm về lĩnh vực Cột sống, Thần kinh, Cơ xương khớp</p>
