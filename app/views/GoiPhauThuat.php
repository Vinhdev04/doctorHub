            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">    
                    <img alt="Illustration of a knee joint" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/phaut-thuat-nam-hoc.png" />
                    <a href="./CoXuongKhop.php" class="card-body" style="text-decoration: none;">
                        <h5 class="card-title">Phẫu Thuật Nam Học</h5>
                    </a>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of a brain" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/phau-thuat-than.png" />
                    <a href="./ThanKinh.php" class="card-body" style="text-decoration: none;">
                        <h5 class="card-title">Phẫu Thuật Thận - Tiết Niệu</h5>
                    </a>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of a stomach" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/phau-thuat-tai-mui-hong.png" />
                    <a href="./TieuHoa.php" class="card-body" style="text-decoration: none;">
                        <h5 class="card-title">Phẫu Thuật Tai-Mũi-Họng</h5>
                    </a>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of a heart with a heartbeat line" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/phau-thuat-hau-mon.png" />
                    <a href="./Timmach.php" class="card-body" style="text-decoration: none;">
                        <h5 class="card-title">Phẫu Thuật Hậu Môn - Trực Tràng</h5>
                    </a>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of an ear, nose, and throat" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/phau-thuat-mat.png" />
                    <div class="card-body">
                        <h5 class="card-title">Phẫu Thuật Mắt</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of a spine" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/thu-thuat-suy-gian-tinh-mach.png" />
                    <div class="card-body">
                        <h5 class="card-title">Thủ thuật Suy giãn Tĩnh Mạch</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of a hand holding a leaf and a medical cross" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/phau-thuat-tuyen-giap.png" />
                    <div class="card-body">
                        <h5 class="card-title">Phẫu Thuật Tuyến Giáp</h5>
                    </div>
                </div>
            </div>
        </div>
