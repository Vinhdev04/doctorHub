...
<body>
        ...
        <div class="hero-section">
            ...
            <div class="overlay">
                <div class="hero-content">
                    <h1 class="page-title">XÉT NGHIỆM Y HỌC</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container content-section">
        <div class="section-header">
            ...
            <h2 class="section-title">Xét nghiệm y học</h2>
        ...
        <div class="category-grid">
            <div class="category-item">
                <div class="category-icon">
                    <img src="../../assets/images/Icon/nangcao-logo.png" alt="Basic checkup">
                </div>
                <span class="category-name">Tổng quát</span>
                <p class="category-description">Gói khám tổng quát đầy đủ các hạng mục cơ bản với chi phí hợp lý</p>
            </div>
            
            <div class="category-item">
                <div class="category-icon">
                    <img src="../../assets/images/Icon/bo-sung-icon-goi-khamtai-nha.png" alt="VIP checkup">
                </div>
                <span class="category-name">Tại nhà</span>
                <p class="category-description">Sau thời điểm đại dịch, các dịch vụ tại nhà đã trở nên quen thuộc và được nhiều người lựa chọn, trong đó dịch vụ xét nghiệm tại nhà.</p>
            </div>
            
            <div class="category-item">
                <div class="category-icon">
                    <img src="../../assets/images/Icon/bo-sung-icon-goi-khamung-thu.png" alt="Advanced checkup">
                </div>
                <span class="category-name">Ung Thư</span>
                <p class="category-description">Ung thư là căn bệnh ngày càng phổ biến và có tỷ lệ tử vong cao. Việc phát hiện sớm ung thư từ giai đoạn đầu có vai trò quan trọng trong việc điều trị</p>
            </div>
            
            <div class="category-item">
                <div class="category-icon">
                    <img src="../../assets/images/Icon/bo-sung-icon-goi-khambau-1.png" alt="Male checkup">
                </div>
                <span class="category-name">NIPT</span>
                <p class="category-description">Xét nghiệm sàng lọc trước sinh không xâm lấn NIPT giúp phát hiện các hội chứng liên quan đến bất thường số lượng nhiễm sắc thể (NST) ở thai nhi thông qua máu mẹ</p>
            </div>
            
            <div class="category-item">
                <div class="category-icon">
                    <img src="../../assets/images/Icon/huyen-icon-xet-nghiem.png" alt="Female checkup">
                </div>
                <span class="category-name">Sốt xuất huyết</span>
                <p class="category-description">Hiện nay, đợt dịch sốt xuất huyết đang diễn ra phức tạp. Với những dấu hiệu khá giống với bệnh cảm cúm nên cần phải thực hiện xét nghiệm để xác định đúng bệnh và có biện pháp điều trị phù hợp, kịp thời.</p>
            </div>
            
            <div class="category-item">
                <div class="category-icon">
                    <img src="../../assets/images/Icon/bo-sung-icon-goi-khamdi-ung-1.png" alt="Children checkup">
                </div>
                <span class="category-name">Dị ứng</span>
                <p class="category-description">Hiện nay, nhiều người gặp phải tình trạng dị ứng với nhiều nguyên nhân khác nhau. Biết được bản thân dị ứng với những yếu tố nào sẽ giúp bạn chủ động phòng tránh được tình huống dị ứng ảnh hưởng tới sức khỏe, thẩm mỹ. </p>
            </div>
        ...
        <div class="packages-grid">
            <div class="package-card">
                <div class="package-image">
                    <img src="../../assets/images/Icon/diag.png" alt="Gói khám tổng quát cơ bản">
                    <span class="package-tag">Phổ biến</span>
                </div>
                <div class="package-content">
                    <h3 class="package-title">Dịch vụ xét nghiệm của Trung tâm xét nghiệm Diag Laboratories</h3>
                    <p class="package-hospital"><i class="fas fa-hospital"></i>Trung tâm xét nghiệm Diag Laboratories</p>
                    <div class="package-features">
                        <div class="feature-item">
                            <i class="fas fa-check-circle feature-icon"></i>
                            <span>Diag đáp ứng nhiều loại xét nghiệm từ cơ bản đến chuyên sâu</span>
                        </div>
                    </div>
                    <div class="feature-item">
                        <i class="fas fa-check-circle feature-icon"></i>
                        <span>Diag hợp tác với các đối tác cung cấp IVD lớn</span>
                    </div>
                    <div class="feature-item">
                        <i class="fas fa-check-circle feature-icon"></i>
                        <span>(IVD - thiết bị y tế chẩn đoán in vitro (IVD) trên toàn cầu để xử lý các mẫu xét nghiệm</span>
                    </div>
                    <div class="feature-item">
                        <i class="fas fa-check-circle feature-icon"></i>
                        <span>Hệ thống máy xét nghiệm tự động, hiện đại, hầu hết được nhập khẩu từ Mỹ, Châu Âu</span>
                    </div>
                    <div class="package-footer">
                        <div class="package-price">
                            Chưa xác định
                        </div>
                        <a class="book-btn" href="../../app/views/dich-vu-xet-nghiem-tai-nha-cua-diag.php" style="text-decoration: none; color: #fff;">Đặt lịch</a>
                    </div>
                </div>
            </div>
            ...
            <div class="package-card">
                <div class="package-image">
                    <img src="../../assets/images/Icon/nipt2.png" alt="Gói khám VIP">
                    <span class="package-tag">NIPT-Plus</span>
                </div>
                <div class="package-content">
                    <h3 class="package-title">Sàng lọc trước sinh không xâm lấn (NIPT-Plus) thường </h3>
                    <p class="package-hospital"><i class="fas fa-hospital"></i>Hệ thống y tế MEDLATEC</p>
                    <div class="package-features">
                        <div class="feature-item">
                            <i class="fas fa-check-circle feature-icon"></i>
                            <span>Phát hiện 3 nhiễm sắc thể phổ biến:  Down, Patau, Edward.</span>
                        </div>
                    </div>
                    <div class="feature-item">
                        <i class="fas fa-check-circle feature-icon"></i>
                        <span>4 hội chứng: Tuner (XO), hội chứng tam nhiễm (XXX), Klinefelter (XXY), Jacobs (XYY).</span>
                    </div>
                    <div class="feature-item">
                        <i class="fas fa-check-circle feature-icon"></i>
                        <span> Phát hiện bất thường các nhiễm sắc thể còn lại.</span>
                    </div>
                    <div class="feature-item">
                        <i class="fas fa-check-circle feature-icon"></i>
                    ...
                    <div class="feature-item">
                        <i class="fas fa-check-circle feature-icon"></i>
                        <span>Thời gian trả kết quả 4 - 5 ngày<span>
                    </div>
                    <div class="package-footer">
                        <div class="package-price">
                            7.500.000đ
                        </div>
                        <a class="book-btn" href="../../app/views/san-loc-truoc-khi-sinh-khong-xam-lan.php" style="text-decoration: none; color: #fff;">Đặt lịch</a>
                    </div>
                </div>
            </div>
            ...
            <div class="package-card">
                <div class="package-image">
                    <img src="../../assets/images/Icon/xet-nghiem-mau.png" alt="Gói khám gia đình">
                    <span class="package-tag">NIPT</span>
                </div>
                <div class="package-content">
                    <h3 class="package-title">Gói xét nghiệm tầm soát dấu ấn ung thư nam (DIAG15M)</h3>
                    <p class="package-hospital"><i class="fas fa-hospital"></i>Trung tâm xét nghiệm Diag Laboratories</p>
                    <div class="package-features">
                        <div class="feature-item">
                            <i class="fas fa-check-circle feature-icon"></i>
                            <span>Gói xét nghiệm bao gồm:</span>
                        </div>
                    </div>
                    <div class="feature-item">
                        <i class="fas fa-check-circle feature-icon"></i>
                        <span>Tầm soát xơ Gan, ung thư Gan, ung thư Phổi</span>
                    </div>
                    <div class="feature-item">
                        <i class="fas fa-check-circle feature-icon"></i>
                        <span>ung thư Tiền liệt tuyến, ung thư Đại tràng, Tụy mật, ung thư Vòm họng,</span>
                    </div>
                    <div class="feature-item">
                        <i class="fas fa-check-circle feature-icon"></i>
                        <span>Kung thư Tuyến giáp.</span>
                    </div>
                    <div class="feature-item">
                        <i class="fas fa-check-circle feature-icon"></i>
                        <span>Gói xét nghiệm tại Trung tâm xét nghiệm Diag Laboratories.</span>
                    </div>
                    ...
                    <div class="package-footer">
                        ...
                        <a class="book-btn" href="../../app/views/goi-kham-xet-nghiem-tam-quat-ung-thu-nam.php" style="text-decoration: none; color: #fff;">Đặt lịch</a>
                    </div>
                </div>
            </div>
        </div>
