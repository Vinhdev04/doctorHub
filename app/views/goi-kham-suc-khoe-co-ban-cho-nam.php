...
<head>
    ...
    <title>Gói khám sức khỏe tổng quát cơ bản cho nam (PKYD1M)</title>
...
<div class="container py-4">
    ...
    <div class="package-header">
        ...
        <div>
            ...
            <h1 class="package-title">Gói khám sức khỏe tổng quát cơ bản cho nam (PKYD1M)</h1>
    ...
    <div class="row g-4">
        <div class="col-lg-8">
            ...
            <!-- Thông tin chi tiết -->
            <div class="package-detail-title">Gói khám sức khỏe tổng quát cơ bản cho nam (PKYD1M)</div>
