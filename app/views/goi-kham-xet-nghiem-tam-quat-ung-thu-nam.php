...
<div class="container py-4">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-white px-0 mb-3">
            ...
            <li class="breadcrumb-item active" aria-current="page">Gói xét nghiệm tầm soát dấu ấn ung thư nam (DIAG15M)</li>
        </ol>
    </nav>
    ...
    <div class="package-header">
        ...
        <div>
            ...
            <h1 class="package-title">Gói xét nghiệm tầm soát dấu ấn ung thư nam (DIAG15M)</h1>
            <ul class="package-info-list">
                <li>Gói xét nghiệm bao gồm: Tầm soát xơ Gan, ung thư Gan, ung thư Phổi, ung thư Tiền liệt tuyến, ung thư Đại tràng, Tụy mật, ung thư Vòm họng, ung thư Tuyến giáp.</li>
                <li>Gói xét nghiệm tại Trung tâm xét nghiệm Diag Laboratories.</li>
            </ul>
    ...
    <div class="row g-4">
        <div class="col-lg-8">
            ...
            <!-- Thông tin chi tiết -->
            <div class="package-detail-title">Gói xét nghiệm tầm soát dấu ấn ung thư nam (DIAG15M)</div>
            <div class="mb-3">Tầm soát ung thư là phương thức chẩn đoán nhằm phát hiện ra mầm mống ung thư khi khối u còn rất nhỏ. Nếu người dân khám sàng lọc và chăm sóc cơ bản thường xuyên thì việc mắc ung thư có thể được phát hiện sớm, qua đó nâng cao hiệu quả điều trị cho bệnh nhân.</div>
            <div class="mb-3 fw-medium">Gói xét nghiệm tại Trung tâm xét nghiệm Diag Laboratories</div>
            <div class="mb-3">            Diag là một trong những trung tâm xét nghiệm danh tiếng tại Việt Nam với hơn 20 năm trong ngành dịch vụ y tế. Diag cung cấp giải pháp toàn diện cho các xét nghiệm y khoa, đảm bảo chất lượng chẩn đoán cho mọi bệnh nhân.</div>
            <ul class="package-detail-list">
                ...
                <li>Cơ sở vật chất tại các chi nhánh lấy mẫu sạch sẽ, thoáng mát<li>
        ...
        <div class="col-lg-4">
            ...
            <div class="info-card">
                <div style="display: flex; align-items: baseline;">
                    ...
                    <span class="fs-5 price-tag" style="margin-left: 10px;">1.290.000đ</span>
        ...
        <div class="mb-4">
                ...
                <div style="background: #fff; border-radius: 0 0 8px 8px; overflow: hidden;">
                    <!-- Khám lâm sàng -->
                    <div style="background: #f7fafd; font-weight: 600; padding: 10px 20px; border-bottom: 1px solid #e0e0e0;">Xét nghiệm</div>
                    <div style="padding: 0;">
                        <div style="display: flex; border-bottom: 1px solid #f0f0f0;">
                            ...
                            <div style="flex: 1; padding: 10px 20px 10px 0;">
                                <div style="font-weight: 500;">Định lượng AFP</div>
                                <div style="font-size: 13px; color: #666;">Là chất chỉ điểm ung thư hỗ trợ chẩn đoán, theo dõi, tiên lượng: Ung thư tế bào gan nguyên phát, u tế bào mầm</div>
                            </div>
                        </div>
                        <div style="display: flex; border-bottom: 1px solid #f0f0f0;">
                            <div style="width: 40px; padding: 10px 0 10px 20px; color: #36c3d6; font-weight: 600;">2</div>
                            <div style="flex: 1; padding: 10px 20px 10px 0;">
                                <div style="font-weight: 500;">Định lượng Cyfra 21-1</div>
                                <div style="font-size: 13px; color: #666;">Tầm soát ung thư phì</div>
                            </div>
                        </div>
                        <div style="display: flex; border-bottom: 1px solid #f0f0f0;">
                            <div style="width: 40px; padding: 10px 0 10px 20px; color: #36c3d6; font-weight: 600;">3</div>
                            <div style="flex: 1; padding: 10px 20px 10px 0;">
                                <div style="font-weight: 500;">Định lượng PSA</div>
                                <div style="font-size: 13px; color: #666;">Kiểm tra và chẩn đoán ung thư tuyến tiền liệt cho nam</div>
                            </div>
                        </div>
                        <div style="display: flex; border-bottom: 1px solid #f0f0f0;">
                            <div style="width: 40px; padding: 10px 0 10px 20px; color: #36c3d6; font-weight: 600;">4</div>
                            <div style="flex: 1; padding: 10px 20px 10px 0;">
                                <div style="font-weight: 500;">Định lượng CEA</div>
                                <div style="font-size: 13px; color: #666;">Là chất chỉ điểm ung thư hỗ trợ chẩn đoán, theo dõi, tiên lượng ung thư biểu mô tuyến tụy, dạ dày, vú, đại tràng, trực tràng và phổi</div>
                            </div>
                        </div>
                        <div style="display: flex; border-bottom: 1px solid #f0f0f0;">
                            <div style="width: 40px; padding: 10px 0 10px 20px; color: #36c3d6; font-weight: 600;">5</div>
                            <div style="flex: 1; padding: 10px 20px 10px 0;">
                                <div style="font-weight: 500;">Định lượng CA 19-9</div>
                                <div style="font-size: 13px; color: #666;">Là chất chỉ điểm ung thư hỗ trợ chẩn đoán, theo dõi, tiên lượng: Ung thư biểu mô tuyến tụy, ung thư đại trực tràng, túi mật, di căn gan</div>
                            </div>
                        </div>
                        <div style="display: flex; border-bottom: 1px solid #f0f0f0;">
                            <div style="width: 40px; padding: 10px 0 10px 20px; color: #36c3d6; font-weight: 600;">6</div>
                            <div style="flex: 1; padding: 10px 20px 10px 0;">
                                <div style="font-weight: 500;">Định lượng SCC</div>
                                <div style="font-size: 13px; color: #666;">Là chất chỉ điểm ung thư, giúp chẩn đoán, theo dõi và tiên lượng ung thư tế bào vảy (Thực quản, cổ tử cung, âm đạo, âm hộ, phổi…)</div>
                            </div>
                        </div>
                        <div style="display: flex; border-bottom: 1px solid #f0f0f0;">
                            <div style="width: 40px; padding: 10px 0 10px 20px; color: #36c3d6; font-weight: 600;">7</div>
                            <div style="flex: 1; padding: 10px 20px 10px 0;">
                                <div style="font-weight: 500;">Định lượng Tg</div>
                                <div style="font-size: 13px; color: #666;">Tầm soát ung thư tuyến giáp</div>
                            </div>
                        </div>
                    </div>
                </div>
